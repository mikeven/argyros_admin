<?php
    /*
     * Argyros Admin - Edición de datos de línea
     * 
     */
    session_start();
...
<html lang="en">
  <head>
    ...
    <title>Editar línea :: Argyros Admin</title>
                  ...
                  <div class="x_content">
                    <form id="frm_mlinea" data-parsley-validate class="form-horizontal form-label-left" 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <textarea class="form-control" rows="3" placeholder="Descripción de la línea" 
                          name="descripcion"><?php echo $linea["description"]; ?></textarea>
                        </div>
                      </div>
