<?php
    /*
     * Argyros Admin - Lista de imágenes de productos
     * 
     */
    session_start();
...
<html lang="en">
  ...
  <head>
        ...
        <title>Imágenes de productos :: Argyros Admin</title>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="tabla_datos-clientes" class="x_content">
                    ...
                    <?php include("sections/tables/table-imgs-prods.php");?>
                    <?php include( "sections/modals/confirm_action.php" ); ?>
                    <input id="id-cliente-e" type="hidden">
                    <input id="id-cliente-b" type="hidden">
                  </div>
                    <form action="fn/fn-products.php" method="post" enctype="multipart/form-data">
