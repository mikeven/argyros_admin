                    ...
                    action="database/data-categories.php?nsubcategoria" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="nombre" type="text" class="form-control" placeholder="Nombre subcategoría" required="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">Categorías </label>
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select name="idcategoria" class="form-control selectpicker" required="">
