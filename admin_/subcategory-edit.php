<?php
    /*
     * Argyros Admin - Edición de datos de subcategorías
     * 
     */
    session_start();
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="input-group" style="float:right;">
                      <a href="subcategories.php" class="btn btn-app">
                        <i class="fa fa-arrow-left"></i> Volver a subcategorías
                      </a>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <form id="frm_msubcategoria" data-parsley-validate class="form-horizontal form-label-left" 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          value="<?php echo $subcategoria["name"]; ?>" name="nombre" required="">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control selectpicker" name="idcategoria" required="">
