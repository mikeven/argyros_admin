...
<html lang="en">
  ...
  <body class="nav-md">
                    ...
                    <form id="frm_nmaterial" data-parsley-validate class="form-horizontal form-label-left" 
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="nombre" type="text" class="form-control" placeholder="Nombre del material" required="">
                        </div>
                      </div>
    ...
    <script src="js/fn-materials.js"></script>
    <script src="js/fn-ui.js"></script>

    <?php include( "fn/fn-materials.php" ); ?>
