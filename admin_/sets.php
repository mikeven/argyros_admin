<?php
    /*
     * Argyros Admin - Juegos de productos
     * 
     */
    session_start();
...
<html lang="en">
  <head>
    ...
    <title>Juegos de productos :: Argyros Admin</title>
    ...
    <style>
      .fselj{ display:none; } .img-j{ padding: 0px 10px 0px 4px; }
    </style>
  </head>

  <?php
    $juegos = obtenerListaJuegosProductos( $dbh );
  ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Juegos de productos</h3>
              </div>

              <div class="title_right">
                <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right">
                  <div class="input-group" style="float:right;">
                    <a href="new-set.php" class="btn btn-app">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div id="tabla_datos-juegos" class="x_content">
                    ...
                    <?php 
                      include( "sections/tables/table-sets.php" );
                    ?>
                    <?php include( "sections/modals/confirm_action.php" ); ?>
                    <input id="id-dpj-e" type="hidden">
                    <input id="id-juego-e" type="hidden">
                  </div>
                </div>
              </div>
