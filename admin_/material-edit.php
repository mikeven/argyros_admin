<?php
    /*
     * Argyros Admin - Edición de datos de material
     * 
     */
    session_start();
    ...
    if( isset( $_GET["id"] ) ){
      $idm = $_GET["id"];
      $material = obtenerMaterialPorId( $dbh, $idm );
    }
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Editar material :: Argyros Admin</title>
                  ...
                  <div class="x_content">
                    ...
                    <form id="frm_mmaterial" data-parsley-validate class="form-horizontal form-label-left" 
                      ...
                      <div class="form-group">
                        <input id="idmaterial" name="idmaterial" type="hidden" value="<?php echo $idm; ?>">
